...
VERSION_URL = "https://raw.githubusercontent.com/BakedTaiyaki093/TyAppsLauncher/refs/heads/main/Version.txt"
...
# "Typath" フォルダをアプリのある場所に作成
folder = APP_FOLDER / "Typath"
folder.mkdir(exist_ok=True)  # フォルダがなければ作成
